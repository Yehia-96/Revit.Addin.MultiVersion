...
using Revit.Addin._2027.Tables.Exporters;
using Revit.Addin._2027.Tables.Services;
using Revit.Addin._2027.Tables.Templates;
using Revit.Addin._2027.Tables.UI;
// .NET 8 ships its own System.Windows.Forms.TaskDialog which clashes with the Revit one
// (both namespaces are imported above); alias the Revit type so the unqualified name resolves.
using TaskDialog = Autodesk.Revit.UI.TaskDialog;

namespace Revit.Addin._2027.Tables.Commands
{
    /// <summary>
