...
using Revit.Addin._2026.Commands;
using Revit.Addin._2026.Updaters;
using System;
using System.Diagnostics;
using System.Reflection;
using System.Windows.Media.Imaging;

namespace Revit.Addin._2026
{
    public class App : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var btnAddParams = new PushButtonData(
                ...
                "Add Parameters\nto Families",
                assemblyPath,
                "Revit.Addin._2026.Commands.AddParametersToFamilies")
            {
            ...
            var btnMaterial = new PushButtonData(
                ...
                "Automate Material\nCreation",
                assemblyPath,
                "Revit.Addin._2026.Commands.MaterialAutomationCommand")
            {
            ...
            var btnPopulateDb = new PushButtonData(
                ...
                "Populate DB\nParameters",
                assemblyPath,
                "Revit.Addin._2026.Commands.PopulateFromDbCommand")
            {
            ...
            var btnTable = new PushButtonData(
                ...
                "Tabelle\nerstellen",
                assemblyPath,
                "Revit.Addin._2026.Tables.Commands.GenerateTableCommand")
            {
            ...
            var btnHide = new PushButtonData(
                ...
                "Hide Elements",
                assemblyPath,
                "Revit.Addin._2026.Commands.ShowByUniqueID")
            {
            ...
            var btnFamilyUpdater = new PushButtonData(
                ...
                "Update Family Files",
                assemblyPath,
                "Revit.Addin._2026.Commands.FamilyFileUpdater")
            {
            ...
            var btnCheckUpdate = new PushButtonData(
                ...
                "Check for Updates",
                assemblyPath,
                "Revit.Addin._2026.Commands.CheckPluginUpdate")
            {
